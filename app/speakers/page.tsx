...
const SpeakersPage = () => {
  const speakers = useQuery(api.queries.getProductsByCategory, { category: 'speakers' });

  return (
    <div>
      {/* Title Section */}
      <section className="w-full h-[239px] bg-[#141414] flex items-center justify-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center">SPEAKERS</h2>
      </section>
